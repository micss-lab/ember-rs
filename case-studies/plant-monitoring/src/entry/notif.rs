    ...
    A: ThresholdConfig + 'static,
{
    ...
    fn fsm(&self) -> Fsm<Self::AgentState, Self::TransitionTrigger, Self::ChildEvent> {
        ...
        Fsm::builder()
            ...
            .with_transition(low_id, normal_id, ThresholdEvent::Normalized)
            .with_transition(high_id, normal_id, ThresholdEvent::Normalized)
            .with_transition(normal_id, low_id, ThresholdEvent::Low)
            .with_transition(normal_id, high_id, ThresholdEvent::High)
            .try_build(normal_id)
            .unwrap()
    }
}
